...
const EVENT_TYPE_CONFIG: Record<string, { icon: any; color: string; label: string }> = {
  ...
  JOINING: { icon: UserPlus, color: 'bg-indigo-100 text-indigo-800', label: 'Joined Company' },
  PROBATION_START: { icon: History, color: 'bg-sky-100 text-sky-800', label: 'Probation Started' },
  PROBATION_END: { icon: History, color: 'bg-emerald-100 text-emerald-800', label: 'Probation Completed' },
